function [residual, g1, g2, g3] = US_DG08_static(y, x, params)
%
...
residual(6)= lhs-rhs;
lhs =y(32);
rhs =params(32)*x(7)+y(36)*params(31)+y(36)*params(30)+y(36)*params(29)+y(36)*params(28)+y(36)*params(27)+y(36)*params(26)+y(36)*params(25)+y(36)*params(24)+y(36)*params(23)+y(35)*params(22)+y(35)*params(21)+y(35)*params(20)+y(35)*params(19)+y(35)*params(18)+y(35)*params(17)+y(35)*params(16)+y(35)*params(15)+y(35)*params(14)+y(34)*params(13)+y(34)*params(12)+y(34)*params(11)+y(34)*params(10)+y(34)*params(6)+y(34)*params(5)+y(32)*params(1)+y(32)*params(2)+y(32)*params(3)+y(32)*params(4)+y(34)*params(7)+y(34)*params(8)+y(34)*params(9);
residual(7)= lhs-rhs;
lhs =y(37);
rhs =params(34)*x(8);
residual(8)= lhs-rhs;
...
T623 = 1-(params(35)/(1+params(35))+1/(1+params(35)));
  g1(1,16)=(-4);
  g1(1,32)=1;
  g1(2,6)=(-4);
  g1(2,33)=1;
  ...
  g1(6,31)=(-1);
  g1(6,37)=1;
  g1(7,32)=1-(params(4)+params(3)+params(1)+params(2));
  g1(7,34)=(-(params(13)+params(12)+params(11)+params(10)+params(9)+params(8)+params(7)+params(6)+params(5)));
  g1(7,35)=(-(params(22)+params(21)+params(20)+params(19)+params(18)+params(17)+params(16)+params(15)+params(14)));
  g1(7,36)=(-(params(31)+params(30)+params(29)+params(28)+params(27)+params(26)+params(25)+params(24)+params(23)));
  g1(8,37)=1;
  g1(9,1)=T623;
  g1(9,4)=T174;
  g1(9,17)=(-T174);
