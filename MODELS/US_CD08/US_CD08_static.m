function [residual, g1, g2, g3] = US_CD08_static(y, x, params)
%
...
residual(5)= lhs-rhs;
lhs =y(35);
rhs =params(32)*x(5)+y(38)*params(31)+y(38)*params(30)+y(38)*params(29)+y(38)*params(28)+y(38)*params(27)+y(38)*params(26)+y(38)*params(25)+y(38)*params(24)+y(38)*params(23)+y(39)*params(22)+y(39)*params(21)+y(39)*params(20)+y(39)*params(19)+y(39)*params(18)+y(39)*params(17)+y(39)*params(16)+y(39)*params(15)+y(39)*params(14)+y(37)*params(13)+y(37)*params(12)+y(37)*params(11)+y(37)*params(10)+y(37)*params(6)+y(37)*params(5)+y(35)*params(1)+y(35)*params(2)+y(35)*params(3)+y(35)*params(4)+y(37)*params(7)+y(37)*params(8)+y(37)*params(9);
residual(6)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(5,9)=(-100);
  g1(5,38)=1;
  g1(6,35)=1-(params(4)+params(3)+params(1)+params(2));
  g1(6,37)=(-(params(13)+params(12)+params(11)+params(10)+params(9)+params(8)+params(7)+params(6)+params(5)));
  g1(6,38)=(-(params(31)+params(30)+params(29)+params(28)+params(27)+params(26)+params(25)+params(24)+params(23)));
  g1(6,39)=(-(params(22)+params(21)+params(20)+params(19)+params(18)+params(17)+params(16)+params(15)+params(14)));
  g1(7,1)=(-params(35));
