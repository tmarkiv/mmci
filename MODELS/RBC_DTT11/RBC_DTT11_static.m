...
T197 = T196/2;
T201 = (exp(y(22))^2-y(10))/1.414213562373095/exp(y(22));
T202 = erf(T201);
...
T430 = T197*T429;
T435 = 2/(1.772453850905516*exp(T207^2));
T437 = exp(y(10))/2*(-T435);
T464 = (1-y(17)/y(18))*(1-y(17)/y(18));
T484 = T196*exp(y(22))*2*exp(y(22))/2/2;
lhs =y(26);
rhs =400*y(2);
residual(1)= lhs-rhs;
lhs =y(27);
...
if nargout >= 2,
  ...
  g1(11,16)=(-1);
  g1(12,6)=(-1);
  g1(12,10)=T430-(exp(y(10))/2*(1-T208)+T437);
  g1(12,22)=T430+(1+T202)*T484-T437;
  g1(13,7)=(-1);
  g1(13,10)=T197*(-T429);
  g1(13,22)=T197*(-T429)+(1-T202)*T484;
  g1(14,9)=(-1);
  ...
  g1(16,17)=(-(exp(y(2))*exp(y(4))*(-(1/y(18)))))/T464;
  g1(16,18)=(-(exp(y(2))*exp(y(4))*(-((-y(17))/(y(18)*y(18))))))/T464;
